...
$sql = "SELECT * FROM informacion WHERE idinformacion=?";
...
<!DOCTYPE html>
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <form class="row g-3" action="updateinformacion.php" method="POST">

        <input type="hidden" name="idinformacion" value="<?php echo $row['idinformacion'] ?>">


        <div class="col-md-6">
      <label for="fiscal" class="form-label">Direccion Fiscal</label>
      <input type="text" class="form-control" name="fiscal" id="fiscal" value="<?php echo $row['fiscal'] ?>">
      </div>

          <div class="col-md-6">
          <label for="entrega" class="form-label">Fecha Fin</label>
          <input type="text" class="form-control" name="entrega" id="entrega" value="<?php echo $row['entrega'] ?>">
          </div>
